...
- <a href="https://arxiv.org/abs/2512.06443"><span class="badge"><i class="fas fa-users"></i> MobiSys</span></a> (<span class="ccf-b">CCF-B</span>). Vec-LUT: Vector Table Lookup for Parallel Ultra-Low-Bit LLM Inference on Edge Devices <span class="award">Best Paper Award Runner-UP</span><br>
