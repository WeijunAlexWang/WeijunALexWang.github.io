...
- <a href="https://arxiv.org/pdf/2503.16525"><span class="badge"><i class="fas fa-file-alt"></i> arXiv 2025</span></a>. KVShare: An LLM Service System with Efficient and Effective Multi-Tenant KV Cache Reuse.<br>
  Huan Yang, Renji Zhang, Mingzhe Huang, **Weijun Wang**, Yin Tang, Yuanchun Li, Yunxin Liu, Deyu Zhang.<br>



- <a href="https://arxiv.org/pdf/2405.17741"><span class="badge"><i class="fas fa-file-alt"></i> arXiv 2024</span></a>. LoRA-Switch: Boosting the Efficiency of Dynamic LLM Adapters via System-Algorithm Co-design.<br>
  Rui Kong, Qiyang Li, Xinyu Fang, Qingtian Feng, Qingfeng He, Yazhu Dong, **Weijun Wang**, Yuanchun Li, Linghe Kong, Yunxin Liu.<br>



- <a href="https://arxiv.org/pdf/2401.05459.pdf"><span class="badge"><i class="fas fa-file-alt"></i> arXiv 2024</span></a>. Personal LLM Agents: Insights and Survey about the Capability, Efficiency and Security. <a href="https://scholar.google.com/citations?view_op=list_works&hl=en&user=ApKD824AAAAJ"><img src="https://img.shields.io/endpoint?url=https%3A%2F%2Fcdn.jsdelivr.net%2Fgh%2Fwjwang410%2Fwjwang410.github.io@google-scholar-stats%2Fpaper_personal_llm_agents_shieldsio.json&logo=Google%20Scholar&labelColor=475569&color=2563EB&logoColor=white&style=flat" alt="Google Scholar Citations (Personal LLM Agents)"></a><br>
...
- <a href="https://arxiv.org/pdf/2411.00915"><span class="badge"><i class="fas fa-users"></i> EuroSys</span></a> (<span class="ccf-a">CCF-A</span>). Empower Vision Applications with LoRA LMM (<span class="acceptance-rate">Fall round, 30/367=8.17%</span>).<br>
  <u>Liang Mi<sup>†</sup></u>, **Weijun Wang<sup>†</sup>\***, <u>Wenming Tu</u>, Qingfeng He, Rui Kong, Xinyu Fang, Yazhu Dong, Yikang Zhang, Yuanchun Li, Meng Li, Haipeng Dai, Guihai Chen, Yunxin Liu, ACM EuroSys 2025.<br>



- <a href="https://github.com/WeijunAlexWang/wwj/tree/master/files/08737545.pdf"><span class="badge"><i class="fas fa-users"></i> INFOCOM</span></a> (<span class="ccf-a">CCF-A</span>). PANDA: Placement of Unmanned Aerial Vehicles Achieving 3D Directional Coverage.<br>
  **Weijun Wang**, Haipeng Dai, Chao Dong, Xiao Chen, Xiaoyu Wang, Guihai Chen, Wanchun Dou, IEEE INFOCOM 2019.<br>



- <a href="http://arxiv.org/abs/2312.15740"><span class="badge"><i class="fas fa-users"></i> INFOCOM</span></a> (<span class="ccf-a">CCF-A</span>). BiSwift: Bandwidth Orchestrator for Multi-Stream Video Analytics on Edge.<br>
  <u>Lin Sun<sup>†</sup></u>, **Weijun Wang<sup>†</sup>**, Tingting Yuan, <u>Liang Mi</u>, Haipeng Dai, Yunxin Liu, Xiaoming Fu, IEEE INFOCOM 2024.<br>



- <a href="https://github.com/WeijunAlexWang/wwj/tree/master/files/INFOCOM2022.pdf"><span class="badge"><i class="fas fa-users"></i> INFOCOM</span></a> (<span class="ccf-a">CCF-A</span>). VSiM: Improving QoE Fairness for Video Streaming in Mobile Environments.<br>
  Yali Yuan<sup>†</sup>, **Weijun Wang<sup>†</sup>**, <u>Yuhan Wang</u>, Sripriya Srikant Adhatarao, Bangbang Ren, Kai Zheng, Xiaoming Fu, IEEE INFOCOM 2022.<br>



- <a href="https://arxiv.org/abs/2301.08664"><span class="badge"><i class="fas fa-users"></i> INFOCOM</span></a> (<span class="ccf-a">CCF-A</span>). AccDecoder: Accelerated Decoding for Neural-enhanced Video Analytics.<br>
  Tingting Yuan<sup>†</sup>, <u>Liang Mi<sup>†</sup></u>, **Weijun Wang\***, Haipeng Dai, Xiaoming Fu, IEEE INFOCOM 2023.<br>


- <a href="https://arxiv.org/abs/2508.18983"><span class="badge"><i class="fas fa-users"></i> ISCA</span></a> (<span class="ccf-a">CCF-A</span>). Enabling MoE on the Edge via Importance-Driven Expert Scheduling.<br>
  Guoying Zhu, Meng Li, Haipeng Dai, Xuechen Liu, **Weijun Wang**, Keran Li, Jun Xiao, Ligeng Chen, Wei Wang, ACM/IEEE ISCA 2026.<br>
...
- <a href="https://github.com/WeijunAlexWang/wwj/tree/master/files/VISIT2019.pdf"><span class="badge"><i class="fas fa-users"></i> SECON</span></a> (<span class="ccf-b">CCF-B</span>). VISIT: Placement of Unmanned Aerial Vehicles for Anisotropic Monitoring Tasks.<br>
...
- <a href="https://github.com/WeijunAlexWang/wwj/tree/master/files/Duet_IWQoS22.pdf"><span class="badge"><i class="fas fa-users"></i> IWQoS</span></a> (<span class="ccf-b">CCF-B</span>). DUET: Joint Deployment of Trucks and Drones for Object Monitoring.<br>
  <u>Lihao Wang<sup>†</sup></u>, **Weijun Wang<sup>†</sup>**, Haipeng Dai, Jiaqi Zheng, Bangbang Ren, Shuyu Shi, Rong Gu, IEEE/ACM IWQoS 2022.<br>
...
- <span class="badge"><i class="fas fa-users"></i> SECON</span> (<span class="ccf-b">CCF-B</span>). Placing Wireless Chargers with Multiple Antennas.<br>
  Haipeng Dai, Yue Zhao, **Weijun Wang**, Rong Gu, Yuben Qu, Chi Lin, Lijie Xu, Wanchun Dou, IEEE SECON 2022.<br>



- <span class="badge"><i class="fas fa-users"></i> SECON</span> (<span class="ccf-b">CCF-B</span>). DARPA: Deployment of UAVs for Polygonal Sizable Object Surveillance.<br>
  Haipeng Dai, Xuzhen Lin, Jiaqi Zheng, Yuben Qu, **Weijun Wang**, Shuyu Shi, Chi Lin, Wanchun Dou, IEEE SECON 2022.<br>



- <a href="https://doi.org/10.1109/ICDCSW56584.2022.00055"><span class="badge"><i class="fas fa-users"></i> ICDCS</span></a> (<span class="ccf-b">CCF-B</span>). Towards Exploiting Stakeholder Resources for Data-Driven Resilient Hazard Management.<br>
  Xiaoming Fu, Tingting Yuan, **Weijun Wang**, Fabian Wolk, Gunter Strunz, IEEE ICDCS 2022.<br>



- <a href="https://github.com/WeijunAlexWang/wwj/tree/master/files/SURF_icdcs2021.pdf"><span class="badge"><i class="fas fa-users"></i> ICDCS</span></a> (<span class="ccf-b">CCF-B</span>). SRUF: Low-Latency Path Routing with SRv6 Underlay Federation in Wide Area Network.<br>
  Bangbang Ren, Deke Guo, Guoming Tang, **Weijun Wang**, Lailong Luo, Xiaoming Fu, IEEE ICDCS 2021.<br>



- <a href="https://github.com/WeijunAlexWang/wwj/tree/master/files/08714083.pdf"><span class="badge"><i class="fas fa-users"></i> ICPP</span></a> (<span class="ccf-b">CCF-B</span>). Heterogeneous Wireless Charger Placement with Obstacles.<br>
  Xiaoyu Wang, Haipeng Dai, **Weijun Wang**, Jiaqi Zheng, Guihai Chen, Wanchun Dou, Xiaobing Wu, IEEE ICPP 2018.<br>


- <span class="badge"><i class="fas fa-users"></i> ICC</span> (<span class="ccf-c">CCF-C</span>). DFRA: Demodulation-free Random Access for UAV Ad Hoc Networks.<br>
  **Weijun Wang**, Chao Dong, Sen Zhu, Hai Wang, IEEE ICC 2017.<br>



- <span class="badge"><i class="fas fa-users"></i> MSN</span> (<span class="ccf-c">CCF-C</span>). Design and Implementation of Adaptive MAC Framework for UAV Ad Hoc Networks.<br>
  **Weijun Wang**, Chao Dong, Hai Wang, Anzhou Jiang, IEEE MSN 2016.<br>



- <span class="badge"><i class="fas fa-users"></i> ICPADS</span> (<span class="ccf-c">CCF-C</span>). Efficient LLM Edge Collaboration Deployment with LoRA. <span class="award">Best Student Paper Award</span><br>
  Yang Xiao, Xin He, **Weijun Wang**, Jian Zhou, Fu Xiao, IEEE ICPADS 2025.<br>
